...
# ---------------------------------------------
# Dashboard de Cursos - Escola Nova Geração
# ---------------------------------------------
st.title("Dashboard de Cursos - Escola Nova Geração")

# 1. Criando a base de dados
dados = {
    "curso": [
        "Reforço de Matemática", "Inglês Básico", "Robótica", "Teatro",
        "Reforço de Português", "Espanhol", "Xadrez", "Pintura"
    ],
    "categoria": [
        "Exatas", "Idiomas", "Tecnologia", "Arte",
...
# 6. Gráfico
st.subheader("Receita por curso")
